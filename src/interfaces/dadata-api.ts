export namespace DadataApi {
  ...
  export type IConstraintsParams = {
    /**
     * "Новосибирск"
     */
    label?: string;
  ...
  export type NameRequest = BaseRequest & {
    /**
  ...
  export type AddressRequestBound = {
    value: string;
  };

  export type AddressRequest = BaseRequest & {
    /**
  ...
  export interface NameResponse extends Response<NameSuggestion> {}
  export interface AddressResponse extends Response<AddressSuggestion> {}
}
